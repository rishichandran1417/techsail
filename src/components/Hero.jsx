...
<button
className="inline-flex w-full sm:w-auto items-center justify-center gap-2 px-6 py-3.5 rounded-md border-2 font-semibold text-sm transition hover:bg-gray-50 active:scale-[0.98]"
style={{
borderColor: NAVY,
color: NAVY,
}}
...
</div>  <div className="mt-10 flex flex-wrap gap-8">  
